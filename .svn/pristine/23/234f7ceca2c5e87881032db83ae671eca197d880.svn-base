    ...
    switch (getSDOcs(m->data[0])) {
        ...
        if (whoami == SDO_SERVER) {
            ...
            if (! err) {
                ...
                failedSDO(d, nodeId, whoami, index, subIndex, SDOABT_INVALID_CLT_SVR_CMD); // as defined in CT SDO subtest 16 SDOABT_LOCAL_CTRL_ERROR);
                return 0xFF;
            }
            /* No line on use. Great !*/
            /* Try to open a new line.*/
        ...
        index=0;
        subIndex=0;
        sendSDOabort (d, whoami, nodeId, index, subIndex, SDOABT_GENERAL_ERROR);
        return 0xFF;
