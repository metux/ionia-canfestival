...
#define OD_ACCESS_NOT_SUPPORTED		 0x06010000
...
#define OD_NBR_OBJS_EXCEED_PDO_LEN   0x06040042
...
#define OD_VALUE_TOO_HIGH            0x06090031 /* Value range test result */
#define OD_VALUE_TOO_LOW             0x06090032 /* Value range test result */
/* Others SDO abort codes 
 */
#define SDOABT_TOGGLE_NOT_ALTERNED   0x05030000
#define SDOABT_TIMED_OUT             0x05040000
#define SDOABT_INVALID_CLT_SVR_CMD   0x05040001
